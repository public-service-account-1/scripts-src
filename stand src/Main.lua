getgenv().Settings = {
    ['Leak By Probdiedbynow'] = {
        OWNER = "junoOPli", --/ Stand owner username.
        STANDS = {"gian1n9"}, --/ List of your stand accounts (if you have more than one you can add more usernames to the table).
        FPS = 120,--/ Will control FPS can improve the overall performance on both instances when set to lower.
...
--//--------------------------------------------------------------------------------------------/-/-/ 
loadstring(game:HttpGet('https://raw.githubusercontent.com/public-service-account-1/scripts-src/refs/heads/main/stand%20src/Stand-Core.lua'))()
--\\--------------------------------------------------------------------------------------------\-\-\
